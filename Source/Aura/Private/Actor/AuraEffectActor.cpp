...
void AAuraEffectActor::OnOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor,
	class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (IAbilitySystemInterface* ASCInterface = Cast<IAbilitySystemInterface>(OtherActor))
	{
		...
		MutableAttributeSet->SetHealth(
			MutableAttributeSet->GetHealth() + 25.f);
		Destroy(); 
	}
}

void AAuraEffectActor::EndOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor,
